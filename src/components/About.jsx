      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="aspect-square max-w-md mx-auto relative rounded-3xl overflow-hidden shadow-2xl bg-slate-100 border border-slate-200">
          ...
          >
            <h2 className="text-sm font-bold tracking-widest text-blue-700 uppercase mb-3">About Me</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-slate-50 p-6 rounded-2xl border border-slate-100">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Bachelor of Computer Applications</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 sm:col-span-2">
                ...
                <div>
                  <h4 className="font-semibold text-slate-900">Core Interests</h4>
                  <p className="text-sm text-slate-600">Business Analytics, Sales Strategy, Data Analysis, Consulting, Market Research</p>
                </div>
              </div>
            </div>
          </motion.div>
