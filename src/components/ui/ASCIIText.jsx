...
class CanvAscii {
  ...
  setMesh() {
    ...
    // For very long text, planeW will be huge. Scale down baseH if textAspect is very large.
    const effectiveBaseH = textAspect > 10 ? baseH * (10 / textAspect) : baseH;
    const planeW = effectiveBaseH * textAspect;
    const planeH = effectiveBaseH;
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #0edaff 0%, #d946ef 50%, #9333ea 100%);
