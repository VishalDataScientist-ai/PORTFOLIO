    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef} className={className}>
        {items.map((item, index) => {
          const baseClassName = `card relative overflow-hidden h-full rounded-2xl bg-slate-800 border-none shadow-[0_0_15px_rgba(0,0,0,0.5)] ${enableBorderGlow ? 'card--border-glow' : ''}`;
